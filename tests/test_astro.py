...
def altaz_to_radec():
    ...
    assert radec_fast.az.deg == pytest.approx(212.967, 1e-3)
    assert radec_fast.alt.deg == pytest.approx(49.440, 1e-3)
    ...
    assert radec_slow.az.deg == pytest.approx(212.764, 1e-3)
    assert radec_slow.alt.deg == pytest.approx(49.546, 1e-3)
